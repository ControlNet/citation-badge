...
- `PEER_REVIEW` belongs to the first Scholar profile. Its `peer_reviews` value is written into `dist/<FIRST_SCHOLAR_ID>/citation.json`, and `review.svg` is generated in `dist/<FIRST_SCHOLAR_ID>/review.svg`.
